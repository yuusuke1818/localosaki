...
/**
 * The primary key class for the m_meter database table.
 * 
 */
@Embeddable
public class MMeterPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MMeterPK)) {
			return false;
		}
		MMeterPK castOther = (MMeterPK)other;
		return 
