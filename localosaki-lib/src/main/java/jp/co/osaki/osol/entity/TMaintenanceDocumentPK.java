...
/**
 * The primary key class for the t_maintenance_document database table.
 * 
 */
@Embeddable
public class TMaintenanceDocumentPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TMaintenanceDocumentPK)) {
			return false;
		}
		TMaintenanceDocumentPK castOther = (TMaintenanceDocumentPK)other;
		return 
