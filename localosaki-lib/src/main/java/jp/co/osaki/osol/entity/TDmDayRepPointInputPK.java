...
/**
 * The primary key class for the t_dm_day_rep_point_input database table.
 *
 */
@Embeddable
public class TDmDayRepPointInputPK implements Serializable {
	...
	@Column(name="dm_day_rep_point_input_id", unique=true, nullable=false)
	private Long dmDayRepPointInputId;

	public TDmDayRepPointInputPK() {
	}
	...
	public Long getDmDayRepPointInputId() {
		return this.dmDayRepPointInputId;
	}
	public void setDmDayRepPointInputId(Long dmDayRepPointInputId) {
		this.dmDayRepPointInputId = dmDayRepPointInputId;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TDmDayRepPointInputPK)) {
			return false;
		}
		TDmDayRepPointInputPK castOther = (TDmDayRepPointInputPK)other;
		return
			...
			&& this.dmDayRepPointInputId.equals(castOther.dmDayRepPointInputId);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.dmDayRepPointInputId.hashCode();
