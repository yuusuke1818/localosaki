...
/**
 * The persistent class for the t_dm_week_rep database table.
 * 
 */
@Entity
@Table(name="t_dm_week_rep")
@NamedQuery(name="TDmWeekRep.findAll", query="SELECT t FROM TDmWeekRep t")
public class TDmWeekRep implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TDmWeekRepPK id;
	...
	public TDmWeekRepPK getId() {
		return this.id;
	}

	public void setId(TDmWeekRepPK id) {
		this.id = id;
	}
	...
	public TDmWeekRepLine addTDmWeekRepLine(TDmWeekRepLine TDmWeekRepLine) {
		...
		TDmWeekRepLine.setTDmWeekRep(this);
	...
	public TDmWeekRepLine removeTDmWeekRepLine(TDmWeekRepLine TDmWeekRepLine) {
		...
		TDmWeekRepLine.setTDmWeekRep(null);
	...
	public TDmWeekRepPoint addTDmWeekRepPoint(TDmWeekRepPoint TDmWeekRepPoint) {
		...
		TDmWeekRepPoint.setTDmWeekRep(this);
	...
	public TDmWeekRepPoint removeTDmWeekRepPoint(TDmWeekRepPoint TDmWeekRepPoint) {
		...
		TDmWeekRepPoint.setTDmWeekRep(null);
