...
/**
 * The primary key class for the t_inspection_meter_rev database table.
 * 
 */
@Embeddable
public class TInspectionMeterRevPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TInspectionMeterRevPK)) {
			return false;
		}
		TInspectionMeterRevPK castOther = (TInspectionMeterRevPK)other;
		return 
