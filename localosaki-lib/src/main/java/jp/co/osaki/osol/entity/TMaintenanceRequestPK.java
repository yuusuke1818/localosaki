...
/**
 * The primary key class for the t_maintenance_request database table.
 * 
 */
@Embeddable
public class TMaintenanceRequestPK implements Serializable {
	...
	@Column(name="maintenance_request_id", unique=true, nullable=false)
	private Long maintenanceRequestId;

	public TMaintenanceRequestPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TMaintenanceRequestPK)) {
			return false;
		}
		TMaintenanceRequestPK castOther = (TMaintenanceRequestPK)other;
		return 
