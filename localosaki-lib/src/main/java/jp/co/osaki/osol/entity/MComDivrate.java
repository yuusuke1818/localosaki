...
/**
 * The persistent class for the m_com_divrate database table.
 * 
 */
@Entity
@Table(name="m_com_divrate")
@NamedQuery(name="MComDivrate.findAll", query="SELECT m FROM MComDivrate m")
public class MComDivrate implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MComDivratePK id;
	...
	@Column(name="div_rate", precision=7, scale=3)
	...
	public MComDivratePK getId() {
		return this.id;
	}

	public void setId(MComDivratePK id) {
		this.id = id;
	}
