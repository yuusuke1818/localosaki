...
/**
 * The primary key class for the m_corp_person database table.
 * 
 */
@Embeddable
public class MCorpPersonPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MCorpPersonPK)) {
			return false;
		}
		MCorpPersonPK castOther = (MCorpPersonPK)other;
		return 
