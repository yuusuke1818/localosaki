...
/**
 * The primary key class for the m_com_divrate database table.
 * 
 */
@Embeddable
public class MComDivratePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MComDivratePK)) {
			return false;
		}
		MComDivratePK castOther = (MComDivratePK)other;
		return 
