...
/**
 * The primary key class for the m_type_stage database table.
 * 
 */
@Embeddable
public class MTypeStagePK implements Serializable {
	...
	@Column(name="basic_date", unique=true, nullable=false)
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MTypeStagePK)) {
			return false;
		}
		MTypeStagePK castOther = (MTypeStagePK)other;
		return 
