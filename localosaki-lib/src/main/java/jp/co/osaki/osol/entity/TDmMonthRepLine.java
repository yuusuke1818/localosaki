...
/**
 * The persistent class for the t_dm_month_rep_line database table.
 * 
 */
@Entity
@Table(name="t_dm_month_rep_line")
@NamedQuery(name="TDmMonthRepLine.findAll", query="SELECT t FROM TDmMonthRepLine t")
public class TDmMonthRepLine implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TDmMonthRepLinePK id;
	...
	public TDmMonthRepLine() {
	}

	public TDmMonthRepLinePK getId() {
		return this.id;
	}

	public void setId(TDmMonthRepLinePK id) {
		this.id = id;
	}
