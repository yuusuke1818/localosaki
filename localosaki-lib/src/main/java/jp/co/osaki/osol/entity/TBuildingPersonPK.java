...
/**
 * The primary key class for the t_building_person database table.
 * 
 */
@Embeddable
public class TBuildingPersonPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TBuildingPersonPK)) {
			return false;
		}
		TBuildingPersonPK castOther = (TBuildingPersonPK)other;
		return 
