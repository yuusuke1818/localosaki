...
/**
 * The primary key class for the t_facility_document database table.
 * 
 */
@Embeddable
public class TFacilityDocumentPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TFacilityDocumentPK)) {
			return false;
		}
		TFacilityDocumentPK castOther = (TFacilityDocumentPK)other;
		return 
