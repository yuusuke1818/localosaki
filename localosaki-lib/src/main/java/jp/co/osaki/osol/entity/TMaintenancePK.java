...
/**
 * The primary key class for the t_maintenance database table.
 * 
 */
@Embeddable
public class TMaintenancePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TMaintenancePK)) {
			return false;
		}
		TMaintenancePK castOther = (TMaintenancePK)other;
		return 
