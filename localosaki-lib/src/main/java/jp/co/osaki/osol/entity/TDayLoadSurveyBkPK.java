...
/**
 * The primary key class for the t_day_load_survey_bk database table.
 * 
 */
@Embeddable
public class TDayLoadSurveyBkPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TDayLoadSurveyBkPK)) {
			return false;
		}
		TDayLoadSurveyBkPK castOther = (TDayLoadSurveyBkPK)other;
		return 
