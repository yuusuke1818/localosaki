...
import jp.co.osaki.osol.api.result.smcontrol.extract.DayReportSelectExtractResult;
import util.SmConstants;
import util.SmControlTestUtil;
import util.SmStub;

public class DayReportSelectTest {

	private static SmControlTestUtil util = new SmControlTestUtil();

	private static SmStub stub;

	private static String API_ID = SmConstants.A200039_TEST;
	...
	public void test_001() {
		...
		try {
			...
			String strCommandParameter = inRb.getString(SmConstants.PARAM_COMMAND);
			String updateDBflg = inRb.getString(SmConstants.PARAM_UPDATE_DB_FLG);

			// リクエスト生成
			String strParam = SmConstants.PARAM_BEAN + "=" + strBean + "&" +
					SmConstants.PARAM_SMID + "=" + strSmId + "&" +
					SmConstants.PARAM_COMMAND + "=" + strCommandParameter + "&" +
					SmConstants.PARAM_UPDATE_DB_FLG + "=" + updateDBflg;
	...
	public void test_002() {
		...
		try {
			...
			String strSmId = inRb.getString(SmConstants.PARAM_SMID);
			String strCommandParameter = inRb.getString(SmConstants.PARAM_COMMAND);
			String strMeasurePointList = inRb.getString(SmConstants.PARAM_MEASURE_POINT_LIST);
			String updateDBflg = inRb.getString(SmConstants.PARAM_UPDATE_DB_FLG);
			...
			String strParam = SmConstants.PARAM_BEAN + "=" + strBean + "&" +
					SmConstants.PARAM_SMID + "=" + strSmId + "&" +
					SmConstants.PARAM_COMMAND + "=" + strCommandParameter + "&" +
					SmConstants.PARAM_MEASURE_POINT_LIST + "=" + strMeasurePointList + "&" +
					SmConstants.PARAM_UPDATE_DB_FLG + "=" + updateDBflg;
	...
	private void commonExecute(String strParam){
		...
		// レスポンスからGsonパースで値セット
		SmControlApiResponse<DayReportSelectExtractResult> param = new Gson().fromJson(output, new TypeToken<SmControlApiResponse<DayReportSelectExtractResult>>(){}.getType());
		DayReportSelectExtractResult paramResult = param.getResult();
		...
		DayReportSelectExtractResult expected = null;
		...
		try {
			...
			if(!(outRb.getString(SmConstants.JSON_RESULT) == null) ) {
				expected =
						new Gson().fromJson(outRb.getString(SmConstants.JSON_RESULT), new TypeToken<DayReportSelectExtractResult>(){}.getType());
