...
public class BulkTemperatureCtrlUpdateTest {
	...
	public void test_001() {
		...
		try {
			...
			String strSettingCondition = inRb.getString(SmConstants.PARAM_SETTING_CONDITION);
			String strSmIdList = inRb.getString(SmConstants.PARAM_SM_ID_LIST);

			// リクエスト生成
			String strParam = SmConstants.PARAM_BEAN + "=" + strBean + "&" +
					SmConstants.PARAM_SETTING_CONDITION + "=" + strSettingCondition + "&" +
...
//	}
	...
	private void commonExecute(String strParam){
		...
		SmControlApiResponse<BulkTemperatureCtrlExtractResult> param = new Gson().fromJson(output, new TypeToken<SmControlApiResponse<BulkTemperatureCtrlExtractResult>>(){}.getType());
		List<BulkApiResultData<BulkTemperatureCtrlExtractResult>> bulkResultList = param.getResultList();
		...
		SmControlApiResponse<BulkTemperatureCtrlExtractResult> expected = null;
		List<BulkApiResultData<BulkTemperatureCtrlExtractResult>> expectedList = null;
		...
		try {
			...
			if(!(outRb.getString(SmConstants.JSON_RESULT) == null) ) {
				expected =
						new Gson().fromJson(outRb.getString(SmConstants.JSON_RESULT), new TypeToken<SmControlApiResponse<BulkTemperatureCtrlExtractResult>>(){}.getType());
