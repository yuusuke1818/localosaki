...
//	}
	...
	private void commonExecute(String strParam){
		...
		SmControlApiResponse<BulkScheduleExtractResult> param = new Gson().fromJson(output, new TypeToken<SmControlApiResponse<BulkScheduleExtractResult>>(){}.getType());
		BulkScheduleExtractResult paramResult = param.getResult();

		List<BulkApiResultData<BulkScheduleExtractResult>> bulkResultList = param.getResultList();
		...
		SmControlApiResponse<BulkScheduleExtractResult> expected = null;
		List<BulkApiResultData<BulkScheduleExtractResult>> expectedList = null;
		...
		try {
			...
			if(!(outRb.getString(SmConstants.JSON_RESULT) == null) ) {
				expected =
						new Gson().fromJson(outRb.getString(SmConstants.JSON_RESULT), new TypeToken<SmControlApiResponse<BulkScheduleExtractResult>>(){}.getType());
		...
		if (!(expected == null)) {
			...
			//				assertThat(paramResult, is(SamePropertyValuesAs.samePropertyValuesAs(expected)));
		}else {
