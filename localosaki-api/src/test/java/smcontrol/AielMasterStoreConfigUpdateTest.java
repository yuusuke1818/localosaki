...
public class AielMasterStoreConfigUpdateTest {

    private static SmControlTestUtil util = new SmControlTestUtil();

    private static SmStub stub;

    private static String API_ID = SmConstants.A210004_TEST;
    ...
    public void test_001() {
        ...
        try {
            ...
            String strDateTime = inRb.getString(SmConstants.PARAM_DATETIME);
            ...
            String strParam = SmConstants.PARAM_BEAN + "=" + strBean + "&" +
                    ...
                    SmConstants.PARAM_DATETIME + "=" + strDateTime + "&" +
