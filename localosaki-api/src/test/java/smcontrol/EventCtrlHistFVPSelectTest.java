...
import jp.co.osaki.osol.api.result.smcontrol.extract.EventCtrlHistFVPSelectExtractResult;
import jp.co.osaki.osol.mng.constants.SmControlConstants;
import util.SmConstants;
import util.SmControlTestUtil;
import util.SmStub;

public class EventCtrlHistFVPSelectTest {

    private static SmControlTestUtil util = new SmControlTestUtil();

    private static SmStub stub;

    private static String API_ID = SmConstants.A200035_TEST;
    ...
    public void test_001() {
        ...
        try {
            ...
            String strloadCtrlAssignment = inRb.getString(SmConstants.PARAM_LOAD_CTRL_ASSIGNMENT);
            ...
            String strParam = SmConstants.PARAM_BEAN + "=" + strBean + "&" +
                    ...
                    SmConstants.PARAM_LOAD_CTRL_ASSIGNMENT + "=" + strloadCtrlAssignment + "&" +
    ...
    public void test_007() {
        stub.setProductCd(SmControlConstants.PRODUCT_CD_E_ALPHA_2);
    ...
    private void commonExecute(String strParam){
        ...
        // レスポンスからGsonパースで値セット
        SmControlApiResponse<EventCtrlHistFVPSelectExtractResult> param = new Gson().fromJson(output, new TypeToken<SmControlApiResponse<EventCtrlHistFVPSelectExtractResult>>(){}.getType());
        EventCtrlHistFVPSelectExtractResult paramResult = param.getResult();
        ...
        EventCtrlHistFVPSelectExtractResult expected = null;
        ...
        try {
            ...
            if(!(outRb.getString(SmConstants.JSON_RESULT) == null) ) {
                expected =
                        new Gson().fromJson(outRb.getString(SmConstants.JSON_RESULT), new TypeToken<EventCtrlHistFVPSelectExtractResult>(){}.getType());
