...
//	}
	...
	private void commonExecute(String strParam){
		...
		DemandSelectExtractResult paramResult = param.getResult();
		...
		DemandSelectExtractResult expected = null;
		...
		try {
			...
			if(!(outRb.getString(SmConstants.JSON_RESULT) == null) ) {
				expected =
						new Gson().fromJson(outRb.getString(SmConstants.JSON_RESULT), new TypeToken<DemandSelectExtractResult>(){}.getType());
