...
import jp.co.osaki.osol.api.result.smcontrol.extract.DemandSelectEaExtractResult;
import jp.co.osaki.osol.mng.constants.SmControlConstants;
import util.SmConstants;
import util.SmControlTestUtil;
import util.SmStub;

public class DemandSelectEaTest {

    private static SmControlTestUtil util = new SmControlTestUtil();

    private static SmStub stub;

    private static String API_ID = SmConstants.A200049_TEST;
    ...
    private void commonExecute(String strParam){
        ...
        // レスポンスからGsonパースで値セット
        SmControlApiResponse<DemandSelectEaExtractResult> param = new Gson().fromJson(output, new TypeToken<SmControlApiResponse<DemandSelectEaExtractResult>>(){}.getType());
        DemandSelectEaExtractResult paramResult = param.getResult();
        ...
        DemandSelectEaExtractResult expected = null;
        ...
        try {
            ...
            if(!(outRb.getString(SmConstants.JSON_RESULT) == null) ) {
                expected =
                        new Gson().fromJson(outRb.getString(SmConstants.JSON_RESULT), new TypeToken<DemandSelectEaExtractResult>(){}.getType());
