...
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgYearReportListLineUsedParameter;
import jp.co.osaki.osol.api.result.energy.ems.DemandOrgYearReportListLineUsedResult;
...
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgYearReportListLineUsedDetailResultData;
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgYearReportListLineUsedHeaderResultData;
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgYearReportListLineUsedHeaderTitleResultData;
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgYearReportListLineUsedSummaryAreaResultData;
...
/**
 * エネルギー使用状況実績取得（個別・年報・系統別使用量） Daoクラス
 *
 * @author ya-ishida
 */
@Stateless
public class DemandOrgYearReportListLineUsedDao extends OsolApiDao<DemandOrgYearReportListLineUsedParameter> {
    ...
    public DemandOrgYearReportListLineUsedDao() {
    ...
    @Override
    public DemandOrgYearReportListLineUsedResult query(DemandOrgYearReportListLineUsedParameter parameter)
            throws Exception {
        DemandOrgYearReportListLineUsedResult result = new DemandOrgYearReportListLineUsedResult();
        DemandOrgYearReportListLineUsedHeaderResultData header = new DemandOrgYearReportListLineUsedHeaderResultData();
        List<DemandOrgYearReportListLineUsedHeaderTitleResultData> headerTitleList = new ArrayList<>();
        List<DemandOrgYearReportListLineUsedDetailResultData> detailList = new ArrayList<>();
        DemandOrgYearReportListLineUsedSummaryAreaResultData summary = new DemandOrgYearReportListLineUsedSummaryAreaResultData();
        ...
        if (ApiGenericTypeConstants.SUMMARY_UNIT.CORP.getVal().equals(parameter.getSummaryKind())) {
            ...
            if (corpDemandList == null || corpDemandList.size() != 1) {
                return new DemandOrgYearReportListLineUsedResult();
            }
        ...
        do {
            ...
            DemandOrgYearReportListLineUsedDetailResultData detail = new DemandOrgYearReportListLineUsedDetailResultData();
        ...
        for (CommonDisplayElementListResult displayElement : displayElementList) {
            ...
            if (ApiCodeValueConstants.ELEMENT_TYPE.LINE_ALL.getVal().equals(displayElement.getElementType())
                ...
                headerTitleList
                        .add(new DemandOrgYearReportListLineUsedHeaderTitleResultData(displayElement.getElementName(),
                ...
                headerTitleList.add(new DemandOrgYearReportListLineUsedHeaderTitleResultData(
            ...
            for (DemandOrgYearReportListLineUsedDetailResultData detail : detailList) {
