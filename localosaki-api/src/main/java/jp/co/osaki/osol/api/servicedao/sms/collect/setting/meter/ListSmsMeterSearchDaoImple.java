...
/**
 * メーター管理 メーター情報一覧取得 ServiceDaoクラス
 * @author kimura.m
 */
public class ListSmsMeterSearchDaoImple implements BaseServiceDao<ListSmsMeterResultData> {
    @Override
    ...
    public List<ListSmsMeterResultData> getResultList(ListSmsMeterResultData target, EntityManager em) {
        ...
        // 条件3: メーターIDがAから始まる
        whereList.add(builder.like(root.get(MMeter_.meterId), METER_KIND.SMART.getVal() + "%"));
