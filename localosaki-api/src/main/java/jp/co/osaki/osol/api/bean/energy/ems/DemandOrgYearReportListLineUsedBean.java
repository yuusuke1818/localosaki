...
import jp.co.osaki.osol.api.dao.energy.ems.DemandOrgYearReportListLineUsedDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgYearReportListLineUsedParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandOrgYearReportListLineUsedResponse;
...
/**
 * エネルギー使用状況実績取得（個別・年報・系統別使用量） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandOrgYearReportListLineUsedBean")
@RequestScoped
public class DemandOrgYearReportListLineUsedBean extends OsolApiBean<DemandOrgYearReportListLineUsedParameter>
        implements BaseApiBean<DemandOrgYearReportListLineUsedParameter, DemandOrgYearReportListLineUsedResponse> {

    private DemandOrgYearReportListLineUsedParameter parameter = new DemandOrgYearReportListLineUsedParameter();

    private DemandOrgYearReportListLineUsedResponse response = new DemandOrgYearReportListLineUsedResponse();

    @EJB
    DemandOrgYearReportListLineUsedDao demandOrgYearReportListLineUsedDao;
     ...
     */
    @Override
    public DemandOrgYearReportListLineUsedParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandOrgYearReportListLineUsedParameter parameter) {
     ...
     */
    @Override
    public DemandOrgYearReportListLineUsedResponse execute() throws Exception {
        DemandOrgYearReportListLineUsedParameter param = new DemandOrgYearReportListLineUsedParameter();
        ...
        DemandOrgYearReportListLineUsedResult result = demandOrgYearReportListLineUsedDao.query(param);
