...
/**
 * エネルギー使用状況実績取得（個別・日報・最大デマンド） Daoクラス
 *
 * @author ya-ishida
 */
@Stateless
public class DemandOrgDayReportListMaxDemandDao extends OsolApiDao<DemandOrgDayReportListMaxDemandParameter> {
    ...
    public DemandOrgDayReportListMaxDemandDao() {
     ...
     */
    @Override
    public DemandOrgDayReportListMaxDemandResult query(DemandOrgDayReportListMaxDemandParameter parameter)
            throws Exception {

        DemandOrgDayReportListMaxDemandResult result = new DemandOrgDayReportListMaxDemandResult();
        ...
        //建物機器情報を取得する
        DemandBuildingSmListDetailResultData demanBuildingSmListParam = DemandEmsUtility
        ...
        List<DemandBuildingSmListDetailResultData> demandBuildingSmList = getResultList(
                demandBuildingSmListServiceDaoImpl, demanBuildingSmListParam);
        ...
        if (demandBuildingSmList != null && demandBuildingSmList.size() >= 2) {
            ...
            return new DemandOrgDayReportListMaxDemandResult();
        }
        ...
        if (header.isTargetSmMultiFlg()) {
            CommonDemandDayReportLineListResult dayReportLineParam = DemandEmsUtility.getDayReportLineListParam(
                    ...
                    ApiGenericTypeConstants.LINE_TARGET.ALL.getVal(), parameter.getYmd(), BigDecimal.ONE,
                    parameter.getYmd(), new BigDecimal("48"));
            ...
            CommonDemandDayMaxListResult dayMaxParam = DemandEmsUtility.getDemandDayMaxListParam(
                    ...
                    parameter.getYmd(), parameter.getYmd(), null, null);
     ...
     * @return
     */
    private DemandOrgDayReportListMaxDemandResult getMaxDemandInfoEmpty(
            DemandOrgDayReportListMaxDemandHeaderResultData header) {
        DemandOrgDayReportListMaxDemandResult ret = new DemandOrgDayReportListMaxDemandResult();
