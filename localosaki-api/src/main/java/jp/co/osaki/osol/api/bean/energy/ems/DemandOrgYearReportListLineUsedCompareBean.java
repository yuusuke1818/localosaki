...
import jp.co.osaki.osol.api.dao.energy.ems.DemandOrgYearReportListLineUsedCompareDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgYearReportListLineUsedCompareParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandOrgYearReportListLineUsedCompareResponse;
...
/**
 * エネルギー使用状況実績取得（個別・年報・データ対比） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandOrgYearReportListLineUsedCompareBean")
@RequestScoped
public class DemandOrgYearReportListLineUsedCompareBean
        extends OsolApiBean<DemandOrgYearReportListLineUsedCompareParameter>
        implements
        BaseApiBean<DemandOrgYearReportListLineUsedCompareParameter, DemandOrgYearReportListLineUsedCompareResponse> {

    private DemandOrgYearReportListLineUsedCompareParameter parameter = new DemandOrgYearReportListLineUsedCompareParameter();

    private DemandOrgYearReportListLineUsedCompareResponse response = new DemandOrgYearReportListLineUsedCompareResponse();

    @EJB
    DemandOrgYearReportListLineUsedCompareDao demandOrgYearReportListLineUsedCompareDao;
     ...
     */
    @Override
    public DemandOrgYearReportListLineUsedCompareParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandOrgYearReportListLineUsedCompareParameter parameter) {
     ...
     */
    @Override
    public DemandOrgYearReportListLineUsedCompareResponse execute() throws Exception {
        DemandOrgYearReportListLineUsedCompareParameter param = new DemandOrgYearReportListLineUsedCompareParameter();
        ...
        param.setYearCompareDestination(this.parameter.getYearCompareDestination());
        param.setYearCompareSource(this.parameter.getYearCompareSource());
        ...
        DemandOrgYearReportListLineUsedCompareResult result = demandOrgYearReportListLineUsedCompareDao.query(param);
