...
import jp.co.osaki.osol.api.dao.energy.ems.DemandOrgWeekReportListLineUsedCompareDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgWeekReportListLineUsedCompareParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandOrgWeekReportListLineUsedCompareResponse;
...
/**
 * エネルギー使用状況実績取得（個別・週報・データ対比） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandOrgWeekReportListLineUsedCompareBean")
@RequestScoped
public class DemandOrgWeekReportListLineUsedCompareBean
        extends OsolApiBean<DemandOrgWeekReportListLineUsedCompareParameter>
        implements
        BaseApiBean<DemandOrgWeekReportListLineUsedCompareParameter, DemandOrgWeekReportListLineUsedCompareResponse> {

    private DemandOrgWeekReportListLineUsedCompareParameter parameter = new DemandOrgWeekReportListLineUsedCompareParameter();

    private DemandOrgWeekReportListLineUsedCompareResponse response = new DemandOrgWeekReportListLineUsedCompareResponse();

    @EJB
    DemandOrgWeekReportListLineUsedCompareDao demandOrgWeekReportListLineUsedCompareDao;
     ...
     */
    @Override
    public DemandOrgWeekReportListLineUsedCompareParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandOrgWeekReportListLineUsedCompareParameter parameter) {
     ...
     */
    @Override
    public DemandOrgWeekReportListLineUsedCompareResponse execute() throws Exception {
        DemandOrgWeekReportListLineUsedCompareParameter param = new DemandOrgWeekReportListLineUsedCompareParameter();
        ...
        param.setFiscalYearCompareDestination(this.parameter.getFiscalYearCompareDestination());
        param.setFiscalYearCompareSource(this.parameter.getFiscalYearCompareSource());
        ...
        DemandOrgWeekReportListLineUsedCompareResult result = demandOrgWeekReportListLineUsedCompareDao.query(param);
