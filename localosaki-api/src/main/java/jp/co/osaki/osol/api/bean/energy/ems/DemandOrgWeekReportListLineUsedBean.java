...
import jp.co.osaki.osol.api.dao.energy.ems.DemandOrgWeekReportListLineUsedDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgWeekReportListLineUsedParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandOrgWeekReportListLineUsedResponse;
...
/**
 * エネルギー使用状況実績取得（個別・週報・系統別使用量） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandOrgWeekReportListLineUsedBean")
@RequestScoped
public class DemandOrgWeekReportListLineUsedBean extends OsolApiBean<DemandOrgWeekReportListLineUsedParameter>
        implements BaseApiBean<DemandOrgWeekReportListLineUsedParameter, DemandOrgWeekReportListLineUsedResponse> {

    private DemandOrgWeekReportListLineUsedParameter parameter = new DemandOrgWeekReportListLineUsedParameter();

    private DemandOrgWeekReportListLineUsedResponse response = new DemandOrgWeekReportListLineUsedResponse();

    @EJB
    DemandOrgWeekReportListLineUsedDao demandOrgWeekReportListLineUsedDao;
     ...
     */
    @Override
    public DemandOrgWeekReportListLineUsedParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandOrgWeekReportListLineUsedParameter parameter) {
     ...
     */
    @Override
    public DemandOrgWeekReportListLineUsedResponse execute() throws Exception {
        DemandOrgWeekReportListLineUsedParameter param = new DemandOrgWeekReportListLineUsedParameter();
        ...
        DemandOrgWeekReportListLineUsedResult result = demandOrgWeekReportListLineUsedDao.query(param);
