...
/**
 * エネルギー使用状況実績取得（個別・月報・最大デマンド） Daoクラス
 *
 * @author ya-ishida
 */
@Stateless
public class DemandOrgMonthReportListMaxDemandDao extends OsolApiDao<DemandOrgMonthReportListMaxDemandParameter> {
    ...
    public DemandOrgMonthReportListMaxDemandDao() {
    ...
    @Override
    public DemandOrgMonthReportListMaxDemandResult query(DemandOrgMonthReportListMaxDemandParameter parameter)
            throws Exception {
        DemandOrgMonthReportListMaxDemandResult result = new DemandOrgMonthReportListMaxDemandResult();
        ...
        result.setDayFrom(summaryRange.getMeasurementDateFrom());
        ...
        if (demandBuildingSmList != null && demandBuildingSmList.size() >= 2) {
            ...
            return new DemandOrgMonthReportListMaxDemandResult();
        }
     ...
     * @return
     */
    private DemandOrgMonthReportListMaxDemandResult getMaxDemandInfoEmpty(
            DemandOrgDayReportListMaxDemandHeaderResultData header) {
        DemandOrgMonthReportListMaxDemandResult ret = new DemandOrgMonthReportListMaxDemandResult();
