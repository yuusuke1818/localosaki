...
import jp.co.osaki.osol.api.dao.sms.collect.setting.meter.ListSmsMeterMeterTypeDao;
...
/**
 * メーター管理 メーター情報メータータイプ一覧取得 Beanクラス
 * @author kimura.m
 */
@Named(value = "listSmsMeterMeterTypeBean")
@RequestScoped
public class ListSmsMeterTypeBean extends OsolApiBean<ListSmsMeterParameter>
implements BaseApiBean<ListSmsMeterParameter, ListSmsMeterResponse> {
    ...
    @EJB
    ListSmsMeterMeterTypeDao listSmsMeterTypeDao;
    ...
    public ListSmsMeterResponse execute() throws Exception {
        ...
        ListSmsMeterResult result = listSmsMeterTypeDao.query(param);
