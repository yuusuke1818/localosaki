...
/**
 *
 * スケジュールパターン(設定) Dao クラス
 *
 * @author t_hayama
 *
 */
@Stateless
public class SchedulePatternUpdateDao extends BaseSmControlDao {
    ...
    public SchedulePatternUpdateDao() {
     ...
     */
    public SmControlScheduleLogRegistResult updateSchedule(FvpCtrlMngResponse<A200062Param> res, Long loginUserId) throws Exception {
        ...
        A200062Param resParam = res.getParam();
     ...
     * @return
     */
    private boolean insertSmControlScheduleLog(A200062Param resParam, Long id, Long loginUserId, Timestamp nowTimestamp, Long smId, TSmControlScheduleLog latestScheduleLog) {
     ...
     */
    private void insertSmControlScheduleTimeLog(A200062Param res, Long id, Long loginUserId, Timestamp nowTimestamp, Long smId, List<TSmControlScheduleTimeLog> latestScheduleTimeLogList) {
     ...
     */
    private void insertSmControlScheduleSetLog(A200062Param res, Long id, Long loginUserId, Timestamp nowTimestamp, Long smId, List<TSmControlScheduleSetLog> latestScheduleSetLogList) {
