...
import jp.co.osaki.osol.api.resultdata.analysis.AnalysisEmsSmListPointDetailResultData;
...
/**
 *
 *集計・分析 EMS実績 対象機器ポイント情報取得  ServiceDaoクラス
 *
 * @author y-maruta
 *
 */

public class AnalysisEmsSmListPointDetailServiceDaoImpl implements BaseServiceDao<AnalysisEmsSmListPointDetailResultData> {
    ...
    @Override
    public List<AnalysisEmsSmListPointDetailResultData> getResultList(AnalysisEmsSmListPointDetailResultData target,
            EntityManager em) {
        String corpId = target.getCorpId();

        CriteriaBuilder builder = em.getCriteriaBuilder();
        CriteriaQuery<AnalysisEmsSmListPointDetailResultData> query = builder.createQuery(AnalysisEmsSmListPointDetailResultData.class);
      ...
      //建物削除フラグ
        ...
        query = query.select(builder.construct(AnalysisEmsSmListPointDetailResultData.class,
    ...
    @Override
    public List<AnalysisEmsSmListPointDetailResultData> getResultList(Map<String, List<Object>> parameterMap,
            EntityManager em) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<AnalysisEmsSmListPointDetailResultData> getResultList(List<AnalysisEmsSmListPointDetailResultData> entityList,
            EntityManager em) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public List<AnalysisEmsSmListPointDetailResultData> getResultList(EntityManager em) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public AnalysisEmsSmListPointDetailResultData find(AnalysisEmsSmListPointDetailResultData target, EntityManager em) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void persist(AnalysisEmsSmListPointDetailResultData target, EntityManager em) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.

    }

    @Override
    public AnalysisEmsSmListPointDetailResultData merge(AnalysisEmsSmListPointDetailResultData target, EntityManager em) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void remove(AnalysisEmsSmListPointDetailResultData target, EntityManager em) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
