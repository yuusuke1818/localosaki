...
/**
 * デマンドデータ実績取得処理（全体・毎月の削減率評価）Daoクラス
 *
 * @author ya-ishida
 */
@Stateless
public class DemandAllSummaryPowerMonthReductionAnalysisDao
        extends OsolApiDao<DemandAllSummaryPowerMonthReductionAnalysisParameter> {
    ...
    public DemandAllSummaryPowerMonthReductionAnalysisDao() {
     ...
     */
    @Override
    public DemandAllSummaryPowerMonthReductionAnalysisResult query(
            DemandAllSummaryPowerMonthReductionAnalysisParameter parameter) throws Exception {
        DemandAllSummaryPowerMonthReductionAnalysisResult result = new DemandAllSummaryPowerMonthReductionAnalysisResult();
        ...
        if (exCorpList == null || exCorpList.size() != 1) {
            return new DemandAllSummaryPowerMonthReductionAnalysisResult();
        }
        ...
        for (AllBuildingListDetailResultData buildingResult : buildingList) {
            ...
            if (ApiCodeValueConstants.COMPARE_TARGET.LAST_YEAR.getVal().equals(parameter.getCompareTarget())) {
                ...
                compareYearParam = DemandEmsUtility.getYearReportLineListParam(buildingResult.getCorpId(),
                        ...
                        String.valueOf(Integer.parseInt(summaryRange.getYearTo()) - 1),
                ...
                compareYearParam = DemandEmsUtility.getYearReportLineListParam(buildingResult.getCorpId(),
                        buildingResult.getBuildingId(), ApiGenericTypeConstants.LINE_TARGET.ALL.getVal(),
