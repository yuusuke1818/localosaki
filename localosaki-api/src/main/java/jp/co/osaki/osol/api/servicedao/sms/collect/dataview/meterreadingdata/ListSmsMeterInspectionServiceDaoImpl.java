...
public class ListSmsMeterInspectionServiceDaoImpl implements BaseServiceDao<ListSmsMeterInspectionDataInfoSearchResultData> {
    ...
    @Override
    public List<ListSmsMeterInspectionDataInfoSearchResultData> getResultList(ListSmsMeterInspectionDataInfoSearchResultData target, EntityManager em) {
        ...
        CriteriaQuery<ListSmsMeterInspectionDataInfoSearchResultData> query = builder.createQuery(ListSmsMeterInspectionDataInfoSearchResultData.class);
        ...
        query = query.select(builder.construct(ListSmsMeterInspectionDataInfoSearchResultData.class,
    ...
    @Override
    public List<ListSmsMeterInspectionDataInfoSearchResultData> getResultList(Map<String, List<Object>> parameterMap, EntityManager em) {

        return null;
    }

    @Override
    public List<ListSmsMeterInspectionDataInfoSearchResultData> getResultList(List<ListSmsMeterInspectionDataInfoSearchResultData> entityList, EntityManager em) {

        return null;
    }

    @Override
    public List<ListSmsMeterInspectionDataInfoSearchResultData> getResultList(EntityManager em) {

        return null;
    }

    @Override
    public ListSmsMeterInspectionDataInfoSearchResultData find(ListSmsMeterInspectionDataInfoSearchResultData target, EntityManager em) {

        return null;
    }

    @Override
    public void persist(ListSmsMeterInspectionDataInfoSearchResultData target, EntityManager em) {

    }

    @Override
    public ListSmsMeterInspectionDataInfoSearchResultData merge(ListSmsMeterInspectionDataInfoSearchResultData target, EntityManager em) {

        return null;
    }

    @Override
    public void remove(ListSmsMeterInspectionDataInfoSearchResultData target, EntityManager em) {
