...
import jp.co.osaki.osol.api.dao.energy.ems.DemandOrgYearReportListTimeZoneUsedDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgYearReportListTimeZoneUsedParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandOrgYearReportListTimeZoneUsedResponse;
...
/**
 * エネルギー使用状況実績取得（個別・年報・時間帯別使用量） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandOrgYearReportListTimeZoneUsedBean")
@RequestScoped
public class DemandOrgYearReportListTimeZoneUsedBean extends OsolApiBean<DemandOrgYearReportListTimeZoneUsedParameter>
        implements
        BaseApiBean<DemandOrgYearReportListTimeZoneUsedParameter, DemandOrgYearReportListTimeZoneUsedResponse> {

    private DemandOrgYearReportListTimeZoneUsedParameter parameter = new DemandOrgYearReportListTimeZoneUsedParameter();

    private DemandOrgYearReportListTimeZoneUsedResponse response = new DemandOrgYearReportListTimeZoneUsedResponse();

    @EJB
    DemandOrgYearReportListTimeZoneUsedDao demandOrgYearReportListTimeZoneUsedDao;
     ...
     */
    @Override
    public DemandOrgYearReportListTimeZoneUsedParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandOrgYearReportListTimeZoneUsedParameter parameter) {
     ...
     */
    @Override
    public DemandOrgYearReportListTimeZoneUsedResponse execute() throws Exception {
        DemandOrgYearReportListTimeZoneUsedParameter param = new DemandOrgYearReportListTimeZoneUsedParameter();
        ...
        DemandOrgYearReportListTimeZoneUsedResult result = demandOrgYearReportListTimeZoneUsedDao.query(param);
