...
public class ListSmsMeterInspectionDataServiceDaoImpl implements BaseServiceDao<ListSmsMeterInspectionDataSearchResultData> {
    @Override
    ...
    @Override
    public List<ListSmsMeterInspectionDataSearchResultData> getResultList(ListSmsMeterInspectionDataSearchResultData target, EntityManager em) {
        ...
        CriteriaQuery<ListSmsMeterInspectionDataSearchResultData> query = builder.createQuery(ListSmsMeterInspectionDataSearchResultData.class);
        ...
        query = query.select(builder.construct(ListSmsMeterInspectionDataSearchResultData.class,
    ...
    @Override
    public List<ListSmsMeterInspectionDataSearchResultData> getResultList(Map<String, List<Object>> parameterMap, EntityManager em) {

        return null;
    }

    @Override
    public List<ListSmsMeterInspectionDataSearchResultData> getResultList(List<ListSmsMeterInspectionDataSearchResultData> entityList, EntityManager em) {

        return null;
    }

    @Override
    public List<ListSmsMeterInspectionDataSearchResultData> getResultList(EntityManager em) {

        return null;
    }

    @Override
    public ListSmsMeterInspectionDataSearchResultData find(ListSmsMeterInspectionDataSearchResultData target, EntityManager em) {

        return null;
    }

    @Override
    public void persist(ListSmsMeterInspectionDataSearchResultData target, EntityManager em) {

    }

    @Override
    public ListSmsMeterInspectionDataSearchResultData merge(ListSmsMeterInspectionDataSearchResultData target, EntityManager em) {

        return null;
    }

    @Override
    public void remove(ListSmsMeterInspectionDataSearchResultData target, EntityManager em) {
