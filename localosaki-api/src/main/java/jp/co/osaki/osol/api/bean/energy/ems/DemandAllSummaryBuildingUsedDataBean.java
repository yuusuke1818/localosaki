...
import jp.co.osaki.osol.api.dao.energy.ems.DemandAllSummaryBuildingUsedDataDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandAllSummaryBuildingUsedDataParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandAllSummaryBuildingUsedDataResponse;
...
/**
 * デマンドデータ実績取得処理（全体・建物・テナント一覧・使用量） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandAllSummaryBuildingUsedDataBean")
@RequestScoped
public class DemandAllSummaryBuildingUsedDataBean extends OsolApiBean<DemandAllSummaryBuildingUsedDataParameter>
        implements BaseApiBean<DemandAllSummaryBuildingUsedDataParameter, DemandAllSummaryBuildingUsedDataResponse> {

    private DemandAllSummaryBuildingUsedDataParameter parameter = new DemandAllSummaryBuildingUsedDataParameter();

    private DemandAllSummaryBuildingUsedDataResponse response = new DemandAllSummaryBuildingUsedDataResponse();

    @EJB
    DemandAllSummaryBuildingUsedDataDao demandAllSummaryBuildingUsedDataDao;
     ...
     */
    @Override
    public DemandAllSummaryBuildingUsedDataParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandAllSummaryBuildingUsedDataParameter parameter) {
        this.parameter = parameter;
    }

    @Override
    public DemandAllSummaryBuildingUsedDataResponse execute() throws Exception {
        DemandAllSummaryBuildingUsedDataParameter param = new DemandAllSummaryBuildingUsedDataParameter();
        ...
        DemandAllSummaryBuildingUsedDataResult result = demandAllSummaryBuildingUsedDataDao.query(param);
