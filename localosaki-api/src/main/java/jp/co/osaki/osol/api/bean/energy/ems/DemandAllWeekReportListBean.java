...
import jp.co.osaki.osol.api.dao.energy.ems.DemandAllWeekReportListDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandAllWeekReportListParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandAllWeekReportListResponse;
...
/**
 * デマンドデータ実績取得処理（全体・週報用） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandAllWeekReportListBean")
@RequestScoped
public class DemandAllWeekReportListBean extends OsolApiBean<DemandAllWeekReportListParameter>
        implements BaseApiBean<DemandAllWeekReportListParameter, DemandAllWeekReportListResponse> {

    private DemandAllWeekReportListParameter parameter = new DemandAllWeekReportListParameter();

    private DemandAllWeekReportListResponse response = new DemandAllWeekReportListResponse();

    @EJB
    DemandAllWeekReportListDao demandAllWeekReportListDao;
     ...
     */
    @Override
    public DemandAllWeekReportListParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandAllWeekReportListParameter parameter) {
     ...
     */
    @Override
    public DemandAllWeekReportListResponse execute() throws Exception {
        DemandAllWeekReportListParameter param = new DemandAllWeekReportListParameter();
        ...
        DemandAllWeekReportListResult result = demandAllWeekReportListDao.query(param);
