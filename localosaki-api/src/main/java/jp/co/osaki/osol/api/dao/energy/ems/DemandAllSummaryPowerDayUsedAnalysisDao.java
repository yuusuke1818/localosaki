...
/**
 * デマンドデータ実績取得処理（全体・毎日の電力量評価） Daoクラス
 *
 * @author ya-ishida
 */
@Stateless
public class DemandAllSummaryPowerDayUsedAnalysisDao extends OsolApiDao<DemandAllSummaryPowerDayUsedAnalysisParameter> {
    ...
    public DemandAllSummaryPowerDayUsedAnalysisDao() {
     ...
     */
    @Override
    public DemandAllSummaryPowerDayUsedAnalysisResult query(DemandAllSummaryPowerDayUsedAnalysisParameter parameter)
            throws Exception {
        DemandAllSummaryPowerDayUsedAnalysisResult result = new DemandAllSummaryPowerDayUsedAnalysisResult();
        ...
        if (exCorpList == null || exCorpList.size() != 1) {
            return new DemandAllSummaryPowerDayUsedAnalysisResult();
        }
