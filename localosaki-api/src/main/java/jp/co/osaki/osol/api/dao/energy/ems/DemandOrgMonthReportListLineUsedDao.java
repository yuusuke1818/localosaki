...
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgMonthReportListLineUsedParameter;
import jp.co.osaki.osol.api.result.energy.ems.DemandOrgMonthReportListLineUsedResult;
...
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgMonthReportListLineUsedDetailResultData;
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgMonthReportListLineUsedHeaderResultData;
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgMonthReportListLineUsedHeaderTitleResultData;
import jp.co.osaki.osol.api.resultdata.energy.ems.DemandOrgMonthReportListLineUsedSummaryAreaResultData;
...
/**
 * エネルギー使用状況実績取得（個別・月報・系統別使用量） Daoクラス
 *
 * @author ya-ishida
 */
@Stateless
public class DemandOrgMonthReportListLineUsedDao extends OsolApiDao<DemandOrgMonthReportListLineUsedParameter> {
    ...
    public DemandOrgMonthReportListLineUsedDao() {
    ...
    @Override
    public DemandOrgMonthReportListLineUsedResult query(DemandOrgMonthReportListLineUsedParameter parameter)
            throws Exception {
        DemandOrgMonthReportListLineUsedResult result = new DemandOrgMonthReportListLineUsedResult();
        DemandOrgMonthReportListLineUsedHeaderResultData header = new DemandOrgMonthReportListLineUsedHeaderResultData();
        List<DemandOrgMonthReportListLineUsedHeaderTitleResultData> headerTitleList = new ArrayList<>();
        List<DemandOrgMonthReportListLineUsedDetailResultData> detailList = new ArrayList<>();
        DemandOrgMonthReportListLineUsedSummaryAreaResultData summary = new DemandOrgMonthReportListLineUsedSummaryAreaResultData();
        ...
        do {
            ...
            DemandOrgMonthReportListLineUsedDetailResultData detail = new DemandOrgMonthReportListLineUsedDetailResultData();
            if (currentDate == null) {
        ...
        for (CommonDisplayElementListResult displayElement : displayElementList) {
            if (ApiCodeValueConstants.ELEMENT_TYPE.LINE_ALL.getVal().equals(displayElement.getElementType())
                ...
                headerTitleList
                        .add(new DemandOrgMonthReportListLineUsedHeaderTitleResultData(displayElement.getElementName(),
                ...
                headerTitleList.add(new DemandOrgMonthReportListLineUsedHeaderTitleResultData(
            ...
            if (linePowerData == null) {
                ...
                for (DemandOrgMonthReportListLineUsedDetailResultData detail : detailList) {
