...
import jp.co.osaki.osol.api.dao.energy.ems.DemandAllDayReportListDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandAllDayReportListParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandAllDayReportListResponse;
...
/**
 * デマンドデータ実績取得処理（全体・日報用） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandAllDayReportListBean")
@RequestScoped
public class DemandAllDayReportListBean extends OsolApiBean<DemandAllDayReportListParameter>
        implements BaseApiBean<DemandAllDayReportListParameter, DemandAllDayReportListResponse> {

    private DemandAllDayReportListParameter parameter = new DemandAllDayReportListParameter();

    private DemandAllDayReportListResponse response = new DemandAllDayReportListResponse();

    @EJB
    DemandAllDayReportListDao demandAllDayReportListDao;

    /* (非 Javadoc)
     * @see jp.skygroup.enl.webap.base.api.BaseApiBean#getParameter()
     */
    @Override
    public DemandAllDayReportListParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandAllDayReportListParameter parameter) {
     ...
     */
    @Override
    public DemandAllDayReportListResponse execute() throws Exception {
        DemandAllDayReportListParameter param = new DemandAllDayReportListParameter();
        ...
        if (param.getSumPeriod() != null &&
                !CheckUtility.checkIntegerRange(param.getSumPeriod().toString(),
                        ApiSimpleConstants.DEMAND_SUM_PERIOD_MIN_VALUE, ApiSimpleConstants.DEMAND_ALL_SUM_PERIOD_MAX_HOUR)) {
            response.setResultCode(OsolApiResultCode.API_ERROR_ORG_PARAMETER_VALID);
            return response;
        }
        ...
        DemandAllDayReportListResult result = demandAllDayReportListDao.query(param);
