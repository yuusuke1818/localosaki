 ...
 */
@Stateless
public class ScheduleSelectDao extends BaseSmControlDao {
     ...
     */
    public SmControlScheduleLogRegistResult updateSchedule(FvpCtrlMngResponse<A200004Param> res,Long loginUserId) throws Exception {
     ...
     // DBサーバ時刻取得
        ...
        A200004Param resParam = res.getParam();
     ...
     * 機器制御スケジュール履歴 登録処理
     */
    private boolean insertSmControlScheduleLog( A200004Param resParam,Long id,Long loginUserId,Timestamp nowTimestamp,Long smId) {
     ...
     */
    private void insertSmControlScheduleTimeLog(A200004Param res,Long id,Long loginUserId,Timestamp nowTimestamp,Long smId) {
     ...
     */
    private void insertSmControlScheduleDutyLog(A200004Param res,Long id,Long loginUserId,Timestamp nowTimestamp,Long smId) {
        List<Map<String, String>> patternMapList = res.getSettingSchedulePatternList();
    ...
    private void insertSmControlScheduleSetLog(A200004Param res,Long id,Long loginUserId,Timestamp nowTimestamp,Long smId,TSmControlScheduleLog latestLog) {
