 ...
 */
@Stateless
public class NationalHolidaySelectDao extends BaseSmControlDao {
    ...
    public NationalHolidaySelectDao() {
    ...
    public void updateBuildingDM(BuildingDmResult param, FvpCtrlMngResponse<A200051Param> res) throws Exception {
     ...
     * @param updateDate
     */
    private void updateHoliday(FvpCtrlMngResponse<A200051Param> res, Long loginUserId, Timestamp updateDate) {
