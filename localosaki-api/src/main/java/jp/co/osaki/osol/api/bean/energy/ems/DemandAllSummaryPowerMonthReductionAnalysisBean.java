...
import jp.co.osaki.osol.api.dao.energy.ems.DemandAllSummaryPowerMonthReductionAnalysisDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandAllSummaryPowerMonthReductionAnalysisParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandAllSummaryPowerMonthReductionAnalysisResponse;
import jp.co.osaki.osol.api.result.energy.ems.DemandAllSummaryPowerMonthReductionAnalysisResult;
import jp.co.osaki.osol.api.utility.energy.ems.DemandEmsAllUtility;
import jp.co.osaki.osol.utility.CheckUtility;
import jp.skygroup.enl.webap.base.api.BaseApiBean;

/**
 * デマンドデータ実績取得処理（全体・毎月の削減率評価） Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandAllSummaryPowerMonthReductionAnalysisBean")
@RequestScoped
public class DemandAllSummaryPowerMonthReductionAnalysisBean
        extends OsolApiBean<DemandAllSummaryPowerMonthReductionAnalysisParameter>
        implements
        BaseApiBean<DemandAllSummaryPowerMonthReductionAnalysisParameter, DemandAllSummaryPowerMonthReductionAnalysisResponse> {

    private DemandAllSummaryPowerMonthReductionAnalysisParameter parameter = new DemandAllSummaryPowerMonthReductionAnalysisParameter();

    private DemandAllSummaryPowerMonthReductionAnalysisResponse response = new DemandAllSummaryPowerMonthReductionAnalysisResponse();

    @EJB
    DemandAllSummaryPowerMonthReductionAnalysisDao demandAllSummaryPowerMonthReductionAnalysisDao;

    /* (非 Javadoc)
     * @see jp.skygroup.enl.webap.base.api.BaseApiBean#getParameter()
     */
    @Override
    public DemandAllSummaryPowerMonthReductionAnalysisParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandAllSummaryPowerMonthReductionAnalysisParameter parameter) {
     ...
     */
    @Override
    public DemandAllSummaryPowerMonthReductionAnalysisResponse execute() throws Exception {
        DemandAllSummaryPowerMonthReductionAnalysisParameter param = new DemandAllSummaryPowerMonthReductionAnalysisParameter();
        ...
        DemandAllSummaryPowerMonthReductionAnalysisResult result = demandAllSummaryPowerMonthReductionAnalysisDao
                .query(param);
