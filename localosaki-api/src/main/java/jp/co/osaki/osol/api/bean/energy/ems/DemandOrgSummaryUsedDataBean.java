...
import jp.co.osaki.osol.api.dao.energy.ems.DemandOrgSummaryUsedDataDao;
import jp.co.osaki.osol.api.parameter.energy.ems.DemandOrgSummaryUsedDataParameter;
import jp.co.osaki.osol.api.response.energy.ems.DemandOrgSummaryUsedDataResponse;
...
/**
 * 電力使用量（目標対比）取得 Beanクラス
 *
 * @author ya-ishida
 */
@Named(value = "DemandOrgSummaryUsedDataBean")
@RequestScoped
public class DemandOrgSummaryUsedDataBean extends OsolApiBean<DemandOrgSummaryUsedDataParameter>
        implements BaseApiBean<DemandOrgSummaryUsedDataParameter, DemandOrgSummaryUsedDataResponse> {

    private DemandOrgSummaryUsedDataParameter parameter = new DemandOrgSummaryUsedDataParameter();

    private DemandOrgSummaryUsedDataResponse response = new DemandOrgSummaryUsedDataResponse();
     ...
     */
    @Override
    public DemandOrgSummaryUsedDataParameter getParameter() {
        return parameter;
    }
     ...
     */
    @Override
    public void setParameter(DemandOrgSummaryUsedDataParameter parameter) {
     ...
     */
    @Override
    public DemandOrgSummaryUsedDataResponse execute() throws Exception {
        DemandOrgSummaryUsedDataParameter param = new DemandOrgSummaryUsedDataParameter();
        ...
        DemandOrgSummaryUsedDataResult result = demandOrgSummaryUsedDataDao.query(param);
