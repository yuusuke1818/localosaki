...
/**
 *
 *集計・分析 EMS実績 建物別サマリー取得  ServiceDaoクラス
 *
 * @author y-maruta
 *
 */

public class AnalysisEmsBuildingSummaryServiceDaoImpl implements BaseServiceDao<AnalysisEmsAllLineSummaryResultData> {
