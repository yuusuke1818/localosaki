 ...
 */
@Stateless
public class DemandUpdateDao extends BaseSmControlDao {
    ...
    // DAO内に処理を記載
    public void updateBuildingDM(BuildingDmResult param, FvpCtrlMngResponse<A200007Param> res) throws Exception {
     ...
     * @param updateDate
     */
    private void updateSmControlLoad(FvpCtrlMngResponse<A200007Param> res, Long loginUserId, Timestamp updateDate) {
        //最小負荷遮断時間リスト
     ...
     * @param updateDate
     */
    private void updateHoliday(FvpCtrlMngResponse<A200007Param> res, Long loginUserId, Timestamp updateDate) {
