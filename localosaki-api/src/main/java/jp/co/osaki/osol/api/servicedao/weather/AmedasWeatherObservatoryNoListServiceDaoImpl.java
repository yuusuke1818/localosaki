...
/**
 * アメダス気象情報のアメダス観測所番号で取得 ServiceDaoクラス
 * @author nishida.t
 *
 */
public class AmedasWeatherObservatoryNoListServiceDaoImpl implements BaseServiceDao<AmedasWeatherListDetailResultData>
{
    ...
    public List<AmedasWeatherListDetailResultData> getResultList(AmedasWeatherListDetailResultData target,
        ...
        String amedasObservatoryNo = target.getAmedasObservatoryNo();
        ...
        //観測所
        whereList.add(builder.equal(root.get(TAmedasWeather_.id).get(TAmedasWeatherPK_.amedasObservatoryNo), amedasObservatoryNo));
