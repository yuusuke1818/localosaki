...
/**
 *
 * スケジュール(取得) Eα Dao クラス
 *
 * @author t_hayama
 *
 */
@Stateless
public class ScheduleSelectEaDao extends BaseSmControlDao {
     ...
     */
    public SmControlScheduleLogRegistResult updateSchedule(FvpCtrlMngResponse<A200059Param> res, Long loginUserId) throws Exception {
        ...
        A200059Param resParam = res.getParam();
     ...
     * @return
     */
    private boolean insertSmControlScheduleLog(A200059Param resParam, Long id, Long loginUserId, Timestamp nowTimestamp, Long smId) {
     ...
     */
    private void insertSmControlScheduleTimeLog(A200059Param res, Long id, Long loginUserId, Timestamp nowTimestamp, Long smId, List<TSmControlScheduleTimeLog> latestScheduleTimeLogList) {
     ...
     * @return
     */
    private boolean insertSmControlScheduleSetLog(A200059Param res, Long id, Long loginUserId, Timestamp nowTimestamp, Long smId, List<TSmControlScheduleSetLog> latestScheduleSetLogList) {
     ...
     * @return
     */
    private int getInsertControlLoadSize(A200059Param actualData, List<TSmControlScheduleSetLog> latestDataList) {
        int ret = 0;
        int minDataSize = 0;
        int maxDataSize = 0;
     ...
     * @return
     */
    private String getScheduleControlInfoFromCommand(A200059Param data) {
       String ret = null;
