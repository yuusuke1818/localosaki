...
import jp.co.osaki.osol.api.dao.smcontrol.MeasurePointSelectDao;
import jp.co.osaki.osol.api.dao.smcontrol.SmCntrolDao;
import jp.co.osaki.osol.api.parameter.smcontrol.MeasurePointSelectParameter;
import jp.co.osaki.osol.api.result.smcontrol.MeasurePointSelectResult;
 ...
 *
 */
@Named(value = SmControlConstants.MEASURE_POINT_SELECT)
@RequestScoped
public class MeasurePointSelectBean extends AbstractApiBean<MeasurePointSelectResult, MeasurePointSelectParameter>{

    @EJB
    private MeasurePointSelectDao dao;
    ...
    @Override
    protected <T extends BaseParam> T initParam(MeasurePointSelectParameter parameter) {
        A200055Param param = new A200055Param();
        ...
        if (SmControlConstants.MEASURE_POINT_INFO_1.equals(param.getMeasurePointInfo())) {
            param.setCommand("V" + history + SmControlConstants.MEASURE_POINT_INFO_1_CMD);
        } else if (SmControlConstants.MEASURE_POINT_INFO_2.equals(param.getMeasurePointInfo())) {
            param.setCommand("V" + history + SmControlConstants.MEASURE_POINT_INFO_2_CMD);
        } else {
            // Not Process
        }
    ...
    protected boolean checkSmPrm(SmPrmResultData smPrm, BaseParam param) throws SmControlException {
        ...
        String measurePointInfo = ((A200055Param)param).getMeasurePointInfo();
    ...
    protected void callDao(FvpCtrlMngResponse<?> response) throws Exception {
        ...
        // param取得
        @SuppressWarnings("unchecked")
        FvpCtrlMngResponse<A200055Param> res = (FvpCtrlMngResponse<A200055Param>) response;
        A200055Param param = res.getParam();
