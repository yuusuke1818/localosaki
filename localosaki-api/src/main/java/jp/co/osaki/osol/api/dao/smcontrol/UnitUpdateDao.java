 ...
 */
@Stateless
public class UnitUpdateDao extends BaseSmControlDao {
...
//            param.setUpdateDate(updateDate);
        ...
        // 機器ID、ポイント番号に検索キーに、ポイント種別一致しないものを取得および更新
//        targetList = getResultList(smPointServiceDaoImpl, paramList);
...
//        for (SmPointResult smPointResult : targetList) {
//            pointNoList.add(smPointResult.getPointNo());
//        }
        ...
        for (BuildingSmResult buildingSm : buidingSmList) {
            ...
            // 機器テーブルResult
            SmPrmResultData SmPrmResultPrm = new SmPrmResultData();
            ...
            // 機器テーブル更新
            merge(smCntrolServiceDaoImpl,SmPrmResultPrm);
