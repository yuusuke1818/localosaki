...
/**
 * SMS 未確定検針アラートメール送信  CSV添付 ロジッククラス
 * @author nishida.t
 *
 */
public class UnsettledMeterReadingLogic extends BaseBatchLogic {
     ...
     * @param batchName
     */
    public UnsettledMeterReadingLogic(String batchName, SmsBatchConfigs smsBatchConfigs) {
     ...
     * @return CSVファイルパス
     */
    public String createUnsettledMeterReadingDataCsv(List<UnsettledMeterReadingDataCsvResultSet> csvDataList, Timestamp svDate) {
        ...
        String outputFileName = smsBatchConfigs.getConfig(SmsBatchConstants.UNSETTLED_METER_READING_DATA_CSV);
        ...
        try {
            ...
            for (UnsettledMeterReadingDataCsvResultSet data : csvDataList) {
                ...
                // 今回検針日時
                dataRow += Objects.toString(convertTimestamp(data.getLatestInspDate()), NULL_CHANGE_STR) + ",";
                // メーター状態
