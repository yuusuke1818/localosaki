...
public class AutoInspLoadSurveyResultSet {
    /* 装置ID */
    ...
    public AutoInspLoadSurveyResultSet(String devId, Long meterMngId, String getDate, BigDecimal kwh, BigDecimal dmvkwh) {
        super();
        this.devId = devId;
