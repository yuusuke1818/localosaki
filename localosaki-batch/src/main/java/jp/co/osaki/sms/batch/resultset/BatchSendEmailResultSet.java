...
/**
 * メール一括送信先宛先 ResultSetクラス
 *
 * @author masumoto_k
 *
 */
public class BatchSendEmailResultSet {
    ...
    public BatchSendEmailResultSet(String mail1, String mail10, String mail2, String mail3, String mail4, String mail5,
            String mail6, String mail7, String mail8, String mail9) {
        super();
        this.mail1 = mail1;
        this.mail10 = mail10;
        this.mail2 = mail2;
