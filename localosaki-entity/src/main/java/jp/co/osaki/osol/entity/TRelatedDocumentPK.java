...
/**
 * The primary key class for the t_related_document database table.
 * 
 */
@Embeddable
public class TRelatedDocumentPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TRelatedDocumentPK)) {
			return false;
		}
		TRelatedDocumentPK castOther = (TRelatedDocumentPK)other;
		return 
