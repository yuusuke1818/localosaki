...
/**
 * The primary key class for the m_manual_insp database table.
 * 
 */
@Embeddable
public class MManualInspPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MManualInspPK)) {
			return false;
		}
		MManualInspPK castOther = (MManualInspPK)other;
		return 
