...
/**
 * The persistent class for the t_building_estimate_kind database table.
 * 
 */
@Entity
@Table(name = "t_building_estimate_kind")
@NamedQueries({
    @NamedQuery(name = "TBuildingEstimateKind.findAll", query = "SELECT t FROM TBuildingEstimateKind t"),
    @NamedQuery(name = "TBuildingEstimateKind.findBuildingId",
            query = "SELECT t FROM TBuildingEstimateKind t"
...
public class TBuildingEstimateKind implements Serializable {

	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TBuildingEstimateKindPK id;
	...
	@ManyToOne
	@JoinColumns({
        @JoinColumn(name = "estimate_corp_id", referencedColumnName = "corp_id", nullable = false, insertable = false, updatable = false),
	...
	public TBuildingEstimateKind() {
	}

	public TBuildingEstimateKindPK getId() {
		return this.id;
	}

	public void setId(TBuildingEstimateKindPK id) {
		this.id = id;
	}
