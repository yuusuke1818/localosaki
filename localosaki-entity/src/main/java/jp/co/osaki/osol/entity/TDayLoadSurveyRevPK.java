...
/**
 * The primary key class for the t_day_load_survey_rev database table.
 * 
 */
@Embeddable
public class TDayLoadSurveyRevPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TDayLoadSurveyRevPK)) {
			return false;
		}
		TDayLoadSurveyRevPK castOther = (TDayLoadSurveyRevPK)other;
		return 
