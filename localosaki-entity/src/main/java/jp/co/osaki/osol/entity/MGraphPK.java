...
/**
 * The primary key class for the m_graph database table.
 * 
 */
@Embeddable
public class MGraphPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MGraphPK)) {
			return false;
		}
		MGraphPK castOther = (MGraphPK)other;
		return 
