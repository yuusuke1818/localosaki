...
/**
 * The primary key class for the m_child_group database table.
 * 
 */
@Embeddable
public class MChildGroupPK implements Serializable {
	...
	@Column(name="child_group_id", unique=true, nullable=false)
	private Long childGroupId;

	public MChildGroupPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MChildGroupPK)) {
			return false;
		}
		MChildGroupPK castOther = (MChildGroupPK)other;
		return 
