...
/**
 * The primary key class for the t_available_energy_line database table.
 * 
 */
@Embeddable
public class TAvailableEnergyLinePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TAvailableEnergyLinePK)) {
			return false;
		}
		TAvailableEnergyLinePK castOther = (TAvailableEnergyLinePK)other;
		return 
