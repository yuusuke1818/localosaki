...
/**
 * The primary key class for the m_sm_line_point database table.
 * 
 */
@Embeddable
public class MSmLinePointPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MSmLinePointPK)) {
			return false;
		}
		MSmLinePointPK castOther = (MSmLinePointPK)other;
		return 
