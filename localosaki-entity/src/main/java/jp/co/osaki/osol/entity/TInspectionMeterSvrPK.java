...
/**
 * The primary key class for the t_inspection_meter_svr database table.
 * 
 */
@Embeddable
public class TInspectionMeterSvrPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TInspectionMeterSvrPK)) {
			return false;
		}
		TInspectionMeterSvrPK castOther = (TInspectionMeterSvrPK)other;
		return 
