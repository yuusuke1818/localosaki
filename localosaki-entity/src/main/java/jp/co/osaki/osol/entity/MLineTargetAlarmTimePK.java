...
/**
 * The primary key class for the m_line_target_alarm_time database table.
 * 
 */
@Embeddable
public class MLineTargetAlarmTimePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MLineTargetAlarmTimePK)) {
			return false;
		}
		MLineTargetAlarmTimePK castOther = (MLineTargetAlarmTimePK)other;
		return 
