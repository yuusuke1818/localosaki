...
/**
 * The primary key class for the t_wk_inspection_incomp database table.
 * 
 */
@Embeddable
public class TWkInspectionIncompPK implements Serializable {
	...
	@Column(name="insp_date", unique=true, nullable=false, length=12)
	private String inspDate;

	public TWkInspectionIncompPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TWkInspectionIncompPK)) {
			return false;
		}
		TWkInspectionIncompPK castOther = (TWkInspectionIncompPK)other;
		return 
			...
			&& this.inspDate.equals(castOther.inspDate);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.inspDate.hashCode();
