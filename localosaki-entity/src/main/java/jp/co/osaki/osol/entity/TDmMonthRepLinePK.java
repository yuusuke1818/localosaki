...
/**
 * The primary key class for the t_dm_month_rep_line database table.
 * 
 */
@Embeddable
public class TDmMonthRepLinePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TDmMonthRepLinePK)) {
			return false;
		}
		TDmMonthRepLinePK castOther = (TDmMonthRepLinePK)other;
		return 
