...
/**
 * The persistent class for the m_price_menu_lightb database table.
 * 
 */
@Entity
@Table(name="m_price_menu_lightb")
@NamedQuery(name="MPriceMenuLightb.findAll", query="SELECT m FROM MPriceMenuLightb m")
public class MPriceMenuLightb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MPriceMenuLightbPK id;
	...
	public MPriceMenuLightb() {
	}

	public MPriceMenuLightbPK getId() {
		return this.id;
	}

	public void setId(MPriceMenuLightbPK id) {
		this.id = id;
	}
