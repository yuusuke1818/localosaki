...
/**
 * The primary key class for the t_energy_use database table.
 * 
 */
@Embeddable
public class TEnergyUsePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TEnergyUsePK)) {
			return false;
		}
		TEnergyUsePK castOther = (TEnergyUsePK)other;
		return 
