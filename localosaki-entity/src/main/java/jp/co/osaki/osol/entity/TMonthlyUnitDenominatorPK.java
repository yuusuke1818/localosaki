...
/**
 * The primary key class for the t_monthly_unit_denominator database table.
 * 
 */
@Embeddable
public class TMonthlyUnitDenominatorPK implements Serializable {
	...
	public TMonthlyUnitDenominatorPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TMonthlyUnitDenominatorPK)) {
			return false;
		}
		TMonthlyUnitDenominatorPK castOther = (TMonthlyUnitDenominatorPK)other;
		return 
