...
/**
 * The persistent class for the t_inspection_meter_rev database table.
 * 
 */
@Entity
@Table(name="t_inspection_meter_rev")
@NamedQuery(name="TInspectionMeterRev.findAll", query="SELECT t FROM TInspectionMeterRev t")
public class TInspectionMeterRev implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TInspectionMeterRevPK id;
	...
	public TInspectionMeterRev() {
	}

	public TInspectionMeterRevPK getId() {
		return this.id;
	}

	public void setId(TInspectionMeterRevPK id) {
		this.id = id;
	}
