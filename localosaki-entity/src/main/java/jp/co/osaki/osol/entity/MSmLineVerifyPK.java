...
/**
 * The primary key class for the m_sm_line_verify database table.
 * 
 */
@Embeddable
public class MSmLineVerifyPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MSmLineVerifyPK)) {
			return false;
		}
		MSmLineVerifyPK castOther = (MSmLineVerifyPK)other;
		return 
