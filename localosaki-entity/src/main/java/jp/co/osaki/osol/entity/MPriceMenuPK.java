...
/**
 * The primary key class for the m_price_menu database table.
 * 
 */
@Embeddable
public class MPriceMenuPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MPriceMenuPK)) {
			return false;
		}
		MPriceMenuPK castOther = (MPriceMenuPK)other;
		return 
