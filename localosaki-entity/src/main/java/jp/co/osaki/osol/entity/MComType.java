...
/**
 * The persistent class for the m_com_type database table.
 * 
 */
@Entity
@Table(name="m_com_type")
@NamedQuery(name="MComType.findAll", query="SELECT m FROM MComType m")
public class MComType implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MComTypePK id;
	...
	public MComTypePK getId() {
		return this.id;
	}

	public void setId(MComTypePK id) {
		this.id = id;
	}
