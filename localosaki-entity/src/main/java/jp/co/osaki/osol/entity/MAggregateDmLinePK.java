...
/**
 * The primary key class for the m_aggregate_dm_line database table.
 * 
 */
@Embeddable
public class MAggregateDmLinePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MAggregateDmLinePK)) {
			return false;
		}
		MAggregateDmLinePK castOther = (MAggregateDmLinePK)other;
		return 
