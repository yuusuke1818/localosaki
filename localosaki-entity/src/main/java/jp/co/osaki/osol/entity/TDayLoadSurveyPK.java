...
/**
 * The primary key class for the t_day_load_survey database table.
 * 
 */
@Embeddable
public class TDayLoadSurveyPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TDayLoadSurveyPK)) {
			return false;
		}
		TDayLoadSurveyPK castOther = (TDayLoadSurveyPK)other;
		return 
