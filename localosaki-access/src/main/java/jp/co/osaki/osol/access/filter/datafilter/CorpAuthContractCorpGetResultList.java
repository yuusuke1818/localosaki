...
/**
 *
 * 契約企業の操作企業の担当者権限のフィルターデータ取得
 *
 * @author take_suzuki
 */
public class CorpAuthContractCorpGetResultList implements GetFilterDataInterface<CorpPersonAuthResultSet, CorpPersonAuthParam> {
