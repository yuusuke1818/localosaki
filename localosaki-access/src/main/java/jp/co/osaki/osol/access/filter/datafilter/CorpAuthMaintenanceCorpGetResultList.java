...
/**
 *
 * メンテナンス企業の操作企業の担当者権限のフィルターデータ取得
 *
 * @author take_suzuki
 */
public class CorpAuthMaintenanceCorpGetResultList implements GetFilterDataInterface<CorpPersonAuthResultSet, CorpPersonAuthParam> {
    ...
    public Map<String, CorpPersonAuthResultSet> getFilterData(EntityManager em, CorpPersonAuthParam param) {
        ...
        //メンテナンス
        conditionList.add(cb.equal(rootMCorp.get(MCorp_.corpType), "2"));
        //アカウント停止フラグ
