...
/**
 *
 * 大崎電気企業の担当者の操作企業の担当者権限のフィルターデータ取得
 *
 * @author take_suzuki
 */
public class CorpAuthOsakiPersonGetResultList implements GetFilterDataInterface<CorpPersonAuthResultSet, CorpPersonAuthParam> {
