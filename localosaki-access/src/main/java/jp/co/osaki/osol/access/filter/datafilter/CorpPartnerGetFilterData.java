...
/**
 *
 * パートナー企業の操作企業のフィルターデータ取得
 *
 * @author take_suzuki
 *
 */
public class CorpPartnerGetFilterData implements GetFilterDataInterface<CorpDataFilterResultSet, PersonDataParam> {
    ...
    public Map<String, CorpDataFilterResultSet> getFilterData(EntityManager em, PersonDataParam param) {
        ...
        query.select(cb.construct(CorpDataFilterResultSet.class,
                ...
                .orderBy(cb.asc(joinMCorpPerson.get(MCorpPerson_.id).get(MCorpPersonPK_.corpId)));
