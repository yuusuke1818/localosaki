 ...
 * @author ozaki.y
 */
public class ListSmsDataViewTenantInfoAllDevServiceDaoImpl implements BaseServiceDao<ListSmsDataViewResultData> {
    ...
    private List<ListSmsDataViewResultData> selectTenantInfoDataList(EntityManager em, String corpId,
            Long buildingId, boolean isTenant, List<String> devIdList, Collection<Long> meterMngIdClct) {
