 ...
 *
 */
public final class SmsApiGateway extends BaseApiGateway {
    /**
     * API PATH
     */
    ...
    public final <P extends OsolApiLoginParameter> OsolApiResponse<?> osolApiPost(String apiServer,
        ...
        apiParameter.setOemName(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.HOSTNAME.getVal()).toString());

        apiParameter.setInqury(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.INQUIRY.getVal()).toString());

        apiParameter.setUserGuide(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.USER_GUIDE.getVal()).toString());

        apiParameter.setUserGuidePdf(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.USER_GUIDE_PDF.getVal()).toString());

        apiParameter.setTermsOfService(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.TERMS_OF_SERVICE.getVal()).toString());

        apiParameter.setTermsOfServicePdf(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.TERMS_OF_SERVICE_PDF.getVal()).toString());

        apiParameter.setLogo(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.LOGO.getVal()).toString());

        apiParameter.setPrivacy(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.PRIVACY.getVal()).toString());

        apiParameter.setFavicon(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.FAVICON.getVal()).toString());

        apiParameter.setCopyright(FacesContext.getCurrentInstance().getExternalContext().getSessionMap()
                .get(OsolConstants.LOGIN_USER_SESSION_KEY.COPYRIGHT.getVal()).toString());
