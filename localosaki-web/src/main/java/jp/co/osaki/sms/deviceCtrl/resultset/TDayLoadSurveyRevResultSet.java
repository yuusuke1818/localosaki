...
public class TDayLoadSurveyRevResultSet {
    ...
    public TDayLoadSurveyRevResultSet() {

    }

    public TDayLoadSurveyRevResultSet(String devId, Long meterMngId, String getDate, BigDecimal dmvKwh, BigDecimal kwh30) {
        this.devId = devId;
