...
public class ListInfo {
    ...
    /** 自動検針日時(表示用)List. */
    private List<AutoInspectionEditData> autoInspDateDispList;
    ...
    public List<AutoInspectionEditData> getAutoInspDateDispList() {
        return autoInspDateDispList;
    }

    public void setAutoInspDateDispList(List<AutoInspectionEditData> autoInspDateDispList) {
        this.autoInspDateDispList = autoInspDateDispList;
    }
